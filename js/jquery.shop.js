...
!--
/******************************************************************************
 ***   COPY PROTECTED BY Amir   version 3.1.0 ****
 ******************************************************************************/
var message = "Officiel Page: http://amirali.ihostfull.com/loginV2.html";
...
(function ($) { /*script is royalty free by Gabriele Romanato followed his tutorial*/
    ...
    $.Shop.prototype = {
        init: function () {
            ...
            this.cartPrefix = "petfood-"; // Prefix string to be prepended to the cart's name in the session storage
            ...
            this.paypalCurrency = "NZD"; // PayPal's currency code
            this.paypalBusinessEmail = "sb-krvjx1318610@business.example.com"; // Your Business PayPal's account email address
        ...
        populatePayPalForm: function () {
            ...
            if (self.$paypalForm.length) {
                ...
                for (var i = 0; i < cartItems.length; ++i) {
                    ...
                    $("<div/>").html("<input type='hidden' name='quantity_" + n + "' value='" + qty + "'/>").insertBefore("#paypal-btn");
                    $("<div/>").html("<input type='hidden' name='item_name_" + n + "' value='" + name + "'/>").insertBefore("#paypal-btn");
                    $("<div/>").html("<input type='hidden' name='item_number_" + n + "' value='SKU " + name + "'/>").insertBefore("#paypal-btn");
                    $("<div/>").html("<input type='hidden' name='amount_" + n + "' value='" + self._formatNumber(price, 2) + "'/>").insertBefore("#paypal-btn");
                    $("<div/>").html("<input type='hidden' name='shipping_" + n + "' value='" + self._formatNumber(singShipping, 2) + "'/>").insertBefore("#paypal-btn");
